...
//*****************************************************************************
//
//! Indicates whether or not the I2C Master is busy, with delay
//!
//! \param ulBase is the base address of the I2C Master module.
//! \param ulCount is the amount of checks to perform before return value.
//!
//! This function returns an indication of whether or not the I2C Master is
//! busy transmitting or receiving data. while busy, if an error occur, returns
//! error as true (busy)
//!
//! \return Returns \b true if the I2C Master is busy; otherwise, returns
//! \b false.
...
//*****************************************************************************
tBoolean
I2CMasterWait(unsigned long ulBase, unsigned long ulCount)
{
    //
    // Check the arguments.
    //
    ...
    // Check busy status.
    //
    while(HWREG(ulBase + I2C_O_MCS) & I2C_MCS_BUSY)
    {
        // check error
        ...
        // decrement counter for next sample
        ulCount--;
