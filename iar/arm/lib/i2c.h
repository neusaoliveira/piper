...
extern tBoolean I2CMasterWait(unsigned long ulBase, unsigned long ulCount);
...
// macro for default 1K and 1M retries
#define I2CMasterWait1K(a)              I2CMasterWait(a, 1000)
#define I2CMasterWait1M(a)              I2CMasterWait(a, 1000000)
