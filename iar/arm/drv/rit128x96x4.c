...
#if RIT_UPSIDE
    /* Display upside down */
    #define RIT_INIT_REMAP      0x41
    #define RIT_INIT_OFFSET     0x60
    static const unsigned char g_pucRIT128x96x4VerticalInc[]   = { 0xA0, 0x45 };
    static const unsigned char g_pucRIT128x96x4HorizontalInc[] = { 0xA0, 0x41 };
#else
    /* Display normal */
