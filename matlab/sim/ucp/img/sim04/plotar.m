...
legend({'Velocidade de Refer\^encia', 'Resposta Obtida'}, ...
     ...
     'Location', 'Best');   
hold off;
print -depsc2 trajC_vt_beamer.eps
%% H
figure('Units','inches',...
    'Position',[1 1 5.04 3.78],...
    'PaperPositionMode','auto');
...
legend({'Altitude de Refer\^encia', 'Resposta Obtida'}, ...
     ...
     'Location', 'Best');   
hold off;
print -depsc2 trajC_h_beamer.eps
%% \psi
figure('Units','inches',...
    'Position',[1 1 5.04 3.78],...
    'PaperPositionMode','auto');
...
legend({'\^Angulo de Refer\^encia', 'Resposta Obtida'}, ...
     ...
     'Location', 'Best');   
hold off;
print -depsc2 trajC_psi_beamer.eps
%% subplots
%subplotB;